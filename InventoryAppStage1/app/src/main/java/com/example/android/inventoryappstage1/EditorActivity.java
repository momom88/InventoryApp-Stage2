...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategorySpiner = (Spinner) findViewById(R.id.spinner_category);
        ...
        mCategorySpiner.setOnTouchListener(mTouchListener);
    ...
    private void setupSpinner() {
        ...
        mCategorySpiner.setAdapter(itemSpinnerAdapter);
    ...
    private void saveItem() {
        ...
        if (mCurrentItemUri == null && TextUtils.isEmpty(nameString) &&
                ...
                && TextUtils.isEmpty(supplierNumberString) && mCategory == ItemEntry.ITEM_UNKNOWN)
        {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // 3 is Headphones, 4 is Computers, 5 is TV).
            // Then call setSelection() so that option is displayed on screen as the current selection.
            switch (category) {
                case ItemEntry.ITEM_CAMERA:
                    mCategorySpiner.setSelection(1);
                    break;
                case ItemEntry.ITEM_PHONE:
                    mCategorySpiner.setSelection(2);
                    break;
                case ItemEntry.ITEM_HEADPHONES:
                    mCategorySpiner.setSelection(3);
                    break;
                case ItemEntry.ITEM_COMPUTERS:
                    mCategorySpiner.setSelection(4);
                    break;
                default:
                    mCategorySpiner.setSelection(0);
                    break;
            }
        }
    }
