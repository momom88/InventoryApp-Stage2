...
public class ItemProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.inventoryappstage1/items" will map to the
        // integer code {@link #ITEMS}. This URI is used to provide access to MULTIPLE rows
        // of the items table.
        sUriMatcher.addURI(StockContract.CONTENT_AUTHORITY, StockContract.PATH_ITEM, ITEMS);
        ...
        // For example, "content://com.example.android.inventoryappstage1/items/2" matches, but
        // "content://com.example.android.inventoryappstage1/items" (without a number at the end) doesn't match.
        sUriMatcher.addURI(StockContract.CONTENT_AUTHORITY, StockContract.PATH_ITEM + "/#", ITEM_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.android.inventoryappstage1/items/3",
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        // Check that the quantity is valid
        Integer supplierPhoneNumber = values.getAsInteger(ItemEntry.COLUMN_ITEM_SUPPLIER_PHONE_NUMBER);
        if (supplierPhoneNumber == null && supplierPhoneNumber < 0) {
            throw new IllegalArgumentException("Item requires valid supplier phone number");
        }
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ItemEntry#COLUMN_ITEM_SUPPLIER_PHONE_NUMBER} key is present,
        // Check that the quantity is valid
